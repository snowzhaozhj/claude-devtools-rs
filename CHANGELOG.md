...
### Fixed
- **CLI**: `self-update` and desktop CLI install now show friendly error messages instead of raw URLs and error chains; download timeout reduced from unlimited/60s to 30s for faster failure feedback.
