...
- **Focus Blue** (`#3b82f6` / code filename `#2563eb`): 搜索 focus ring、resize handle、链接、pin icon、临时 pulse。它是定位与交互焦点，不是装饰色。
- **Control Indigo** (`#6366f1`): 开关开启态、项目 dropdown check、少量设置控件。用于确认配置状态，不替代蓝色焦点语义。

### Tertiary

- **Execution Green** (`#15803d`, dark `#4ade80`): 成功工具结果、diff added、终端 prompt、完成状态。
