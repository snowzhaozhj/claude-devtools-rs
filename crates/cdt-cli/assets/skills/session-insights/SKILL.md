...
| Goal | Sequence |
|---|---|
| **Daily summary** | `sessions list --since 2026-06-08 --until 2026-06-09 --group-by project --json=projectName,sessionId,title,userIntents,durationMs,totalCost,filesModified,gitSummary` — one command, all data for a daily report. Use `--since/--until YYYY-MM-DD` for calendar days, NOT `--since 1d` (rolling 24h window). |
