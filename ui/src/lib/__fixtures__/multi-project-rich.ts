...
const aiChunk: AIChunk = {
  ...
  semanticSteps: [
    ...
    {
      kind: 'tool_execution',
      toolUseId: 'tu-active-read',
      toolName: 'Read',
      timestamp: ts(0.32),
    },
    {
      kind: 'tool_execution',
      toolUseId: 'tu-active-edit',
      toolName: 'Edit',
      timestamp: ts(0.33),
    },
    {
      kind: 'tool_execution',
      toolUseId: 'tu-active-write',
      toolName: 'Write',
      timestamp: ts(0.335),
    },
    {
  ...
  toolExecutions: [
    ...
    },
    {
      toolUseId: 'tu-active-read',
      toolName: 'Read',
      input: { file_path: '/Users/test/rust-port/crates/cdt-api/src/ipc/mod.rs' },
      output: { kind: 'text', text: '1\tuse crate::LocalDataApi;\n2\tuse serde::Serialize;\n3\t\n4\t#[derive(Serialize)]\n5\t#[serde(rename_all = "camelCase")]\n6\tpub struct SessionSummary {\n7\t    pub session_id: String,\n8\t    pub title: Option<String>,\n9\t    pub message_count: u32,\n10\t}' },
      isError: false,
      startTs: ts(0.32),
      endTs: ts(0.325),
      sourceAssistantUuid: 'a-active-1',
    ...
    },
    {
      ...
      toolName: 'Edit',
      input: {
        file_path: '/Users/test/rust-port/crates/cdt-api/src/ipc/mod.rs',
        old_string: '    pub message_count: u32,',
        new_string: '    pub message_count: u32,\n    pub is_ongoing: bool,',
      },
      output: { kind: 'text', text: 'The file has been updated successfully.' },
      isError: false,
      startTs: ts(0.33),
      endTs: ts(0.332),
      sourceAssistantUuid: 'a-active-1',
    ...
    },
    {
      ...
      toolName: 'Write',
      input: {
        file_path: '/Users/test/rust-port/crates/cdt-api/src/ipc/types.rs',
        ...
        '1': [
          ...
          },
          {
            ...
            toolBreakdown: [
              ...
              { toolName: 'Read', tokenCount: 150, isError: false, toolUseId: 'tu-active-read' },
              { toolName: 'Edit', tokenCount: 130, isError: false, toolUseId: 'tu-active-edit' },
              { toolName: 'Write', tokenCount: 120, isError: false, toolUseId: 'tu-active-write' },
            ],
          },
        ],
        '2': [
